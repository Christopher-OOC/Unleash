...
public class InstructorApiController {
	...
	public InstructorApiController(InstructorService instructorService, ModelMapper modelMapper, CourseService courseService) {
		super();
	...
	public ResponseEntity<?> addACourse(@RequestBody @Valid CourseDto courseDto, @PathVariable("instructorId") @Positive(message="The instructor ID must be positive") int instructorId) {
	...
	public ResponseEntity<?> getAllCoursesByInstructor(@PathVariable("instructorId") 
		@Positive(message="Instuctor ID must be positive") int instructorId) {
